...
<html>
<head>
    <title>Selenium Ecosystem</title>
    <%@include file="/jsp/head.jspf"%>
</head>
<body class="sectionAbout">
<%@include file="/jsp/header.jspf"%>
<div id="mainContent">
    <h1>Selenium Ecosystem</h1>
    ...
    <ul>
        ...
        <li>
            <a rel="nofollow" href="http://www.rttsweb.com/training/courses/open-source">RTTS</a> -
            RTTS is a QA Consulting firm with introductory and advanced courses for Selenium.
        </li>
        <li>
            <a rel="nofollow" href="http://www.factoryconsulting.com">FACTory Consulting</a> -
            France-based firm delivering software testing services including Selenium training in french.
        </li>
        <li>
            <a rel="nofollow" href="http://www.dev9.com/selenium/">Dev9</a> -
